...
function Carrito() {
  ...
  const eliminarProducto = (productoId) => {
    setListCarrito(listCarrito.filter(producto => producto.id !== productoId)); //filtra la lista para que aparezcan todos los productos que tengan un id distinto al que se le pasa
  };
